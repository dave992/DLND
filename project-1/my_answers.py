...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h = self.lr*np.matmul(hidden_error_term.T, X[:, None])
        # Weight step (hidden to output)
        delta_weights_h_o = self.lr*np.matmul(output_error_term.T, hidden_outputs)
    ...
    def run(self, features):
        ...
        hidden_inputs = np.matmul(features, self.weights_input_to_hidden.T)       # signals into hidden layer
